...
def search_web_ref(query:str, debug=False):
    ...
    try:
        ...
        response = requests.get('https://search.gakwayaremy.com?q=' + safe_string + '&format=json')
...
def gen_prompt(question,content_list, lang="en-US", context_length_limit=11000,debug=False):
